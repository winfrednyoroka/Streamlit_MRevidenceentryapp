...
with st.sidebar:
     st.title("This is data entry form for extracting data from Mendelian randomization papers")
     st.subheader("It consists of 6 tabs for the 6 tables")

tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["Study","Exposure","Outcome","Method","Effectsizetype","Results"])
def form():
    with tab1:
    ...
    with tab2:
        with st.form(key="EXPOSURE",clear_on_submit=True):
             ...
             st.write("E1:BMI,E2:Adiposity,E3:WHR,E4:childhoodBMI,E5:adultBMI,E6:fatmassindex,E7:fatfreemassindex,E8:FA,E9:UFA,E10:obesity,E11:bodyfat%,E12:BMIWGRS,E13:BMIGRS,E14:WHtR,E15:VAT")
             exposurename=st.selectbox("exposure name",["BMI","Adiposity","WHR","childhoodBMI","adultBMI","fatmassindex","fatfreemassindex","FA","UFA","obesity","bodyfat%","BMIWGRS","BMIGRS","WHtR","VAT"])
             exposureid=st.selectbox("Enter expid",["E1","E2","E3","E4","E5","E6","E7","E8","E9","E10","E11","E12","E13","E14","E15"])
    ...
    with tab4:
        with st.form(key="METHOD",clear_on_submit=True):
             ...
             st.write("M1:IVW,M2:Wetmedian,M3:Wetmode,M4:MREgger,M5:IVestimator,M6:MVMR,M7:penalisedwetmedian,M8:SIMEXcorrectedMREgger,M9:MRGXE,M10:TSLS,M11:MR-PRESSO,M12:Contaminationmixture,M13:MR-LDP,M14:RAPS,M15:LDA_MRE,MR16:LDMR,M17:PLDMRa,M18:PLDMR")
    ...
    with tab5:
        with st.form(key="EFFECTSIZE",clear_on_submit=True):
             ...
             st.write("ID1:OR,ID2:MD,ID3:HR,ID4:BETA,ID5:RiskDifference")
